...
export const VersionBadge: React.FC<VersionBadgeProps> = ({ version, changeCount, onClick }) => {
  return (
    <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
      <Button
        ...
        data-drae-action="open_whats_new"
        data-drae-location="version_badge"
        data-drae-version={version}
      >
