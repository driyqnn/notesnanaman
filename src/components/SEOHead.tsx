  ...
  useEffect(() => {
    ...
    const createMetaDescription = () => {
      ...
      if (pageType === 'changelog') {
        return 'Track file system changes, version history, and updates across all academic resources. View detailed changelogs with file additions, modifications, and deletions.';
      } else if (pageType === 'feedback') {
        return 'Provide feedback and suggestions to improve the academic resource browser. Help us enhance your study experience.';
      } else if (currentPath === '/') {
