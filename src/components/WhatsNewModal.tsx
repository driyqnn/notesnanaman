              ...
              return (
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    {path && (
                      <div className="text-[10px] text-muted-foreground mt-0.5 whitespace-normal break-words max-w-[75%] overflow-hidden">
                        {path}
                      </div>
                    )}
                  </div>
...
export const WhatsNewModal: React.FC<WhatsNewModalProps> = ({
  ...
  // Memoize derived data to avoid heavy work on open
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-w-[95vw] max-h-[90vh] glass border-border">
        ...
        <ScrollArea className="flex-1 max-h-[calc(90vh-120px)] scrollbar-thin">
