...
const VersionCard: React.FC<{
  ...
  const renderFileList = (files: ChangeItem[], type: 'added' | 'deleted' | 'modified') => {
    ...
    return (
      <div className="mt-2">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <span className="font-medium text-xs capitalize">{type} Files</span>
            ...
            {hasChanges ? (
              <div className="pt-3 space-y-3">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
                  ...
                  {renderFileList(version.changes.modified_files, 'modified')}
